    ...
    function init() {
      ...
      mount.innerHTML = `
        ...
        <div class="jobdog-logo">
          <img src="https://yacineboua.github.io/jobdog-widget/jobdog_logo.png?v=1" alt="Jobdog Logo" style="width: 40px; height: 40px; background: transparent; border: none; display: block;">
          <h1>jobdog</h1>
        </div>
